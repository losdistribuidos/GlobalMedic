...
namespace WCFGlobalMedic
{
    ...
    // NOTA: para iniciar el Cliente de prueba WCF para probar este servicio, seleccione SedeService.svc o SedeService.svc.cs en el Explorador de soluciones e inicie la depuración.
